...
static void generate_yolov5_proposals(float* feat_blob, int output_size, float prob_threshold, std::vector<Object>& objects)
{
...
static void decode_outputs(float* prob, 
    ...
    generate_yolov5_proposals(prob, output_size, BBOX_CONF_THRESH, proposals);
