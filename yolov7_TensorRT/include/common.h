...
static void draw_objects(const cv::Mat& image, const std::vector<Object>& objects, std::string f)
{
...
static void generate_yolov7_proposals(float* feat_blob, int output_size, float prob_threshold, std::vector<Object>& objects)
{
...
static void decode_outputs(float* prob, 
    ...
    generate_yolov7_proposals(prob, output_size, BBOX_CONF_THRESH, proposals);
